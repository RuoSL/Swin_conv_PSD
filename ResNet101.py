...
# Model
# =========================================================
class ResNet101PSD(pl.LightningModule):
    def __init__(self, lr=1e-4, weight_decay=1e-3, pretrained=True):
        super().__init__()
        self.save_hyperparameters()

        self.backbone = create_model("resnet101", pretrained=pretrained, num_classes=0)
...
def run_cv(
    ...
    mode_name = "resnet101_psd_leave_one_area_out"
    structure_tag = "resnet101_psd"
    ...
    for fold_idx in range(n_splits):
        ...
        model = ResNet101PSD(lr=1e-4, weight_decay=1e-3, pretrained=pretrained)
        ...
        if best_ckpt:
            ...
            model = ResNet101PSD.load_from_checkpoint(best_ckpt)
...
def main():
    ...
    run_cv(
        ...
        base_ckpt_dir="./checkpoints/resnet101_psd",
        base_curve_dir="./loss_curves/resnet101_psd",
        run_id=run_id
    )
