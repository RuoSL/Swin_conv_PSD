...
def run_leave_one_area_out(
    ...
    max_depth=None,
    glcm_levels=32,
    output_dir="./rf_results/glcm_fft_extratrees_new_leave_one_area_out_monotonic"
):
    ...
    for test_area in AREAS:
        ...
        metrics["mode"] = "glcm_fft_extratrees"
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./rf_results/glcm_fft_extratrees_new_leave_one_area_out_monotonic")
